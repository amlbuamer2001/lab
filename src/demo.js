...
console.log("Is Saturday a weekend? ".concat(isWeekend(WeekDays.Saturday)));
console.log("Is Sunday a weekend? ".concat(isWeekend(WeekDays.Sunday)));
console.log("Is Monday a weekend? ".concat(isWeekend(WeekDays.Monday)));
console.log("Is Tuesday a weekend? ".concat(isWeekend(WeekDays.Monday)));
console.log("Is Wednesday a weekend? ".concat(isWeekend(WeekDays.Wednesday)));
console.log("Is Thursday a weekend? ".concat(isWeekend(WeekDays.Wednesday)));
console.log("Is Friday a weekend? ".concat(isWeekend(WeekDays.Wednesday)));
